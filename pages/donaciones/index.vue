        ...
        <div class="grid grid-cols-1 gap-12 lg:grid-cols-2">
          ...
          <div class="space-y-8">
            <div class="text-left">
              ...
              <p class="text-gray-600">
                Tu donación monetaria nos permite cubrir gastos veterinarios urgentes, comprar
                alimento y mantener nuestras instalaciones.
              </p>
            </div>
            ...
            <div class="grid gap-4 sm:grid-cols-1">
              <!-- PayPal (Destacado) -->
              <div
                class="rounded-2xl border-2 border-emerald-100 bg-white p-6 shadow-sm transition-all hover:border-emerald-300 hover:shadow-md"
              >
              ...
              <div class="grid gap-4 sm:grid-cols-2">
                ...
                >
                  <div>
                    ...
                    <p class="mt-1 text-xs text-gray-500 group-hover:text-gray-700">
                      Donación recurrente mensual
                    </p>
                  </div>
                  <div class="mt-4 text-right">
                    <span class="text-sm font-semibold text-red-500 group-hover:underline">
                      Ver niveles →
                    </span>
                  </div>
                </NuxtLink>
                ...
                >
                  <div>
                    ...
                    <p class="mt-1 text-xs text-gray-500 group-hover:text-gray-700">
                      Micro-donaciones puntuales
                    </p>
                  </div>
                  <div class="mt-4 text-right">
                    <span class="text-sm font-semibold text-[#29abe0] group-hover:underline">
                      Donar $5 →
                    </span>
                  </div>
                </NuxtLink>
            ...
            <div class="rounded-xl bg-amber-50 p-4 text-sm text-amber-800">
              <div class="flex items-start gap-3">
                ...
                <p class="italic">
                  "Después de donar, recibí un correo detallado sobre cómo mi aporte ayudó a Max a
                  recibir su tratamiento. ¡Increíble transparencia!" —
                  <span class="font-bold not-italic">Laura M.</span>
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="flex flex-col rounded-3xl bg-emerald-50 p-8 lg:p-10">
            <div class="mb-6">
              <h2 class="mb-2 flex items-center gap-3 text-3xl font-bold text-emerald-800">
                <div
                  class="flex h-12 w-12 items-center justify-center rounded-full bg-white text-emerald-600"
                >
              ...
              <p class="text-emerald-900/80">
                ¿Prefieres donar insumos? Aceptamos alimentos, medicinas y materiales para nuestros
                refugios aliados.
              </p>
            </div>
...
useSeoMeta({
  ...
  description:
    'Tu ayuda salva vidas. Apoya nuestra misión de rescatar y cuidar mascotas en Zulia con donaciones económicas o en especie.',
